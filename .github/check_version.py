...
Check version number in setup.json and aiida_sshonly/__init__.py and make sure
they match.
"""
...
import aiida_sshonly  # pylint: disable=wrong-import-position
version = aiida_sshonly.__version__
